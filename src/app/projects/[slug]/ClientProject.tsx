...
function HomeContent({ slug }: { slug: string }) {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-gradient-to-b from-darkest-green/90 via-darkest-green/70 to-darkest-green/90 md:from-green-950/10 md:via-transparent md:to-transparent pointer-events-none" />
      <div className="absolute inset-0 bg-gradient-to-b from-green-950/10 to-transparent md:block hidden pointer-events-none" />
      <Head>
